            ...
            <div className="flex flex-col gap-2">
              ...
              >
                <div className="flex items-center gap-2">
                  <ShoppingBag className="w-4 h-4" /> {t("marketplace.items")}
                </div>
              </button>
              <button
              ...
              >
                <div className="flex items-center gap-2">
                  <Gift className="w-4 h-4" /> {t("marketplace.coupons")}
                </div>
              </button>
            </div>
          </div>
        ...
        <div className="flex-1">
          {loadingProducts ? (
            ...
            <div className="py-20 text-center border-2 border-dashed rounded-3xl bg-muted/20">
              ...
              <h3 className="text-lg font-bold mb-1">{t("marketplace.noProducts")}</h3>
